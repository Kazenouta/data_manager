    ...
    a.fn.scroll_absolute = function(d) {
        function e(d, e) {
            function f(b) {
                var e, h, j, l, m, n, q = !1,
                    r = !1;
                if (P = b, Q === c) m = d.scrollTop(), n = d.scrollLeft(), d.css({ overflow: "hidden", padding: 0 }), R = d.innerWidth() + tb, S = d.innerHeight(), d.width("100%"), Q = a('<div class="scroll_absolute"></div>').css("padding", sb).append(d.children()), T = a('<div class="scroll_container"></div>').css({ width: "100%", height: S + "px" }).append(Q).appendTo(d);
                else {
            ...
            function k() {
                ...
                Z && Q.width("100%"), V = Q.outerHeight(), X = V / S, Z && (ob = Math.ceil(1 / W * nb), ob > P.horizontalDragMaxWidth ? ob = P.horizontalDragMaxWidth : ob < P.horizontalDragMinWidth && (ob = P.horizontalDragMinWidth), bb.width(ob + "px"), cb = nb - ob, u(db)), Y && (ib = Math.ceil(1 / X * hb),
            ...
            function n(b, c, d, e) { d = a(d).addClass("easy_active");
                var f, g, h = !0,
            ...
            function o() { p(), Y && fb.bind("mousedown.easy", function(b) {
                    if (b.originalTarget === c || b.originalTarget == b.currentTarget) {
                        var d, e = a(this),
                            ...
                            j = function() { d && clearTimeout(d), d = null, a(document).unbind("mouseup.easy", j) };
                        return i(), a(document).bind("mouseup.easy", j), !1 } }), Z && mb.bind("mousedown.easy", function(b) {
                    if (b.originalTarget === c || b.originalTarget == b.currentTarget) {
                        var d, e = a(this),
                            f = e.offset(),
                            g = b.pageX - f.left - db,
            ...
            function s(a) { a === c && (a = $.position().top), T.scrollTop(0), ab = a;
                var b = 0 === ab,
                    e = ab == _,
                    f = a / _,
                    g = -f * (V - S);
            ...
            function u(a) { a === c && (a = bb.position().left), T.scrollTop(0), db = a;
                var b = 0 === db,
                    e = db == cb,
                    f = a / cb,
                    g = -f * (U - R);
                (xb != b || zb != e) && (xb = b, zb = e, d.trigger("easy-arrow-change", [wb, yb, xb, zb])), w(b, e), Q.css("left", "0"), d.trigger("easy-scroll-x", [-g, b, e]).trigger("scroll") }
            ...
            function E() { T.unbind(Bb).bind(Bb, function(a, b, c, d) {
                    var e = db,
                        f = ab;
            ...
            function J() {
                function b() {
                    ...
                    return e = a != db || b != ab }
                var c, e, f = [];
                Z && f.push(lb[0]), Y && f.push(eb[0]), Q.focus(function() { d.focus() }), d.attr("tabindex", 0).unbind("keydown.easy keypress.easy").bind("keydown.easy", function(d) {
                    if (d.target === this || f.length && a(d.target).closest(f).length) {
                        ...
                        switch (d.keyCode) {
                            ...
                            case 36:
                                x(0), c = null }
                        return e = d.keyCode == c && g != db || h != ab, !e } }).bind("keypress.easy", function(a) {
                    return a.keyCode == c && b(), !e }), P.hideFocus ? (d.css("outline", "none"), "hideFocus" in T[0] && d.attr("hideFocus", !0)) : (d.css("outline", "none"), "hideFocus" in T[0] && d.attr("hideFocus", !1)) }
            ...
            function M() { a(document.body).data("easy_hijack") || (a(document.body).data("easy_hijack", !0), a(document.body).delegate("a[href*=#]", "click", function(c) {
            ...
            function N() {
                ...
                T.unbind("touchstart.easy touchmove.easy touchend.easy click.easy-touchclick").bind("touchstart.easy", function(g) {
                    ...
                    a = A(), b = B(), c = h.pageX, d = h.pageY, e = !1, f = !0 }).bind("touchmove.easy", function(g) {
                    if (f) {
                        var h = g.originalEvent.touches[0],
                            i = db,
                            j = ab;
                        return vb.scrollTo(a + c - h.pageX, b + d - h.pageY), e = e || Math.abs(c - h.pageX) > 5 || Math.abs(d - h.pageY) > 5, i == db && j == ab } }).bind("touchend.easy", function() { f = !1 }).bind("click.easy-touchclick", function() {
            ...
            sb = d.css("padding-top") + " " + d.css("padding-right") + " " + d.css("padding-bottom") + " " + d.css("padding-left"), tb = (parseInt(d.css("padding-left"), 10) || 0) + (parseInt(d.css("padding-right"), 10) || 0), a.extend(vb, { reinitialise: function(b) { b = a.extend({}, P, b), f(b) }, scrollToElement: function(a, b, c) { z(a, b, c) }, scrollTo: function(a, b, c) { y(a, c), x(b, c) }, scrollToX: function(a, b) { y(a, b) }, scrollToY: function(a, b) { x(a, b) }, scrollToPercentX: function(a, b) { y(a * (U - R), b) }, scrollToPercentY: function(a, b) { x(a * (V - S), b) }, scrollBy: function(a, b, c) { vb.scrollByX(a, c), vb.scrollByY(b, c) }, scrollByX: function(a, b) {
                    var c = A() + Math[0 > a ? "floor" : "ceil"](a),
                        d = c / (U - R);
                    t(d * cb, b) }, scrollByY: function(a, b) {
        ...
        return d = a.extend({}, a.fn.scroll_absolute.defaults, d), a.each(["arrowButtonSpeed", "trackClickSpeed", "keyboardSpeed"], function() { d[this] = d[this] || d.speed }), this.each(function() {
            var b = a(this),
                c = b.data("easy");
